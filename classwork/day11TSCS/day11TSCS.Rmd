...
setwd('~/QPMR/classwork/day11TSCS/')
library(readstata13)
data = read.dta13('../day10temporal/WCRWreplication.dta')
```
...
- We will first deal with last week's protest data
...
REmod = plm(Ethnic_Vote_Share ~ Log_Casualty,
            ...
            index = 'Year',
    model='random')
FEmod = plm(Ethnic_Vote_Share ~ Log_Casualty  + 1 | Year,
                         data = data2,
    index='Year',
    model='within')
phtest(FEmod, REmod)
